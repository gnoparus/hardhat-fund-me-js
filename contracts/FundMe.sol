...
error FundMe__NotEnouchETH();

/// @title A coontract for crownd funding
/// @author Bob Smith
...
contract FundMe {
    ...
    function withdrawCheap() public payable onlyOwner {
        ...
        // require(sendSuccess, "Send failed");
        // call
        (bool callSuccess, ) = payable(msg.sender).call{value: thisBalance}("");
        require(callSuccess, "Call failed");
    }
